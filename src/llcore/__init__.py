...
**健全な収縮証明ゲート (sound contraction-certifier ladder: 閉形式 ∞-norm /
頂点 2-norm / Lyapunov SDP) で破綻させずに** 進化させる研究フレームワーク。
Z3/SMT は optional の不変量チェックに使う (証明の主役は収縮 certifier)。
