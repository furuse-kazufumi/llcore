...
def main():
    ...
    else:  # full (GPU/Kaggle; cert runs on CPU, so cert_every>1 keeps the run tractable < 12h)
        cfg = dict(n=8, layers=1, d=64, T=64, B=16, lr=3e-3, grad_steps=400, evo_gens=150,
                   sigma=0.12, eval_batches=6, max_chars=80000, cert_every=3)
