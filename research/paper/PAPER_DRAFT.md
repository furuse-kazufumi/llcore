...
- **Reproduction scripts and primary result JSON.** The following table is the authoritative list of
  ...
  | Viability robustness sweep (§9.6) | `run_viability_robustness.py` → `results_viability_robustness.json` | 12/12 both axes (seed/κ 1.5–3.0/dim 24/delay 20 × 2 substrates); worst capability gap −0.007; soundness violations 0 | VIABILITY_VERDICT.md addendum ② |
