...
- 2026-06-15 review 反映:
  ...
  - 当時の branch 上には今回の 3 commit と無関係な既存 dirty が残っていたが、現時点の llcore 側 dirty は別件の未追跡 `research/highdim_evolution/make_hd1_null_viz.py` のみ。`.llterm/loop_ledger.jsonl` は `3d1f6ab` で追跡解除済み
