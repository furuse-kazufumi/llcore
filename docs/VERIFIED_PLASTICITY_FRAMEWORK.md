...
機械学習の歴史は、特徴量や構造を人が与える設計から、機械が自ら構造を獲得する方向へ進んできた。本研究の進化テーゼ(構造を人が固定せず機械が online に獲得する)はこの流れと同型であり、本枠組みは、その「機械が自ら獲得する」境界拡張に対し、**発散しないことの保証**を後付けで課す装置と位置づけられる。
